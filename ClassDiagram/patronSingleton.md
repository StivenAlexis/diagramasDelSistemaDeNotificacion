...
classDiagram
  class Profesor {
    +Int dni
    +List<IPlataformaDeComunicacionStrategy> plataformas Preferidas
  ...
  class IPlataformaDeComunicacionStrategy {
    ...
    +ProgramarCalendario(notificacion Notificacion)
  }
  class SmsStrategy {
  ...
  class NotificacionMediatorSingleton {
    -NotificacionMediatorSingleton instancia
    -NotificacionMediatorSingleton()
    +getinstancia(): NotificacionMediatorSingleton
  ...
  Profesor --> NotificacionMediatorSingleton: mediador
 
  DepartamentoDeCoordinacion --> NotificacionMediatorSingleton : mediador
